      ...
      return (
        <Fragment>
          <button
            ...
            className="self-center px-8 py-3 rounded font-semibold hover:bg-yellow-500"
          >
            {t("sign in")}
          </button>
          <button
            ...
            className="self-center px-8 py-3 rounded font-semibold text-coolGray-50 hover:bg-yellow-500"
          >
            {t("register")}
          </button>
        </Fragment>
